...
export class CustomerOnboarding implements OnInit {
  ...
  onboardingForm = [
    ...
    { title: "PG Stay Details", fields: ["Check-in Date", { label: 'Room Sharing Type', type: 'dropdown', options: ['Single', 'Double', 'Triple', 'Four (Up)', 'Four (Down)'] }, { label: 'Room Number', type: 'dropdown', options: [ '0001', '0002','0010','0020','0030','0040','0100','0200','0300','0400','1000','2000','3000'] },"Bed Number", { label: 'Monthly Rent', type: 'dropdown', options: [ '24000', '12000','9000','7500','7000'] }, { label: 'Security Deposit', type: 'dropdown', options: [ '24000', '12000','9000','7500','7000'] }, "Advance Paid So For","Rent Paid So For"] },
    ...
    { title: "Emergency Contact", fields: ["Emergency Contact Name", "Relationship", "Mobile Number"] },
